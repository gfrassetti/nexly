...
import unifiedWebhookRouter from "./routes/unifiedWebhook";
...
app.use("/unified-inbox", requireAuth, unifiedInboxRouter);
app.use("/unified-webhook", unifiedWebhookRouter);
