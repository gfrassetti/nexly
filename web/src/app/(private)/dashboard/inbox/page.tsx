  ...
  return (
    <div className="h-full flex flex-col bg-accent-dark text-accent-cream">
      ...
      <div className="border-b border-neutral-700 bg-neutral-800 flex-shrink-0">
          ...
          <div className="flex gap-1 sm:gap-2 overflow-x-auto">
            {CHANNELS.map((c) => (
              <button
                ...
                disabled={isLoading}
                className={`px-2 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors capitalize flex items-center gap-1 sm:gap-2 whitespace-nowrap ${
                  channel === c 
                    ? "bg-green-600 text-accent-cream shadow-lg" 
        ...
        <div className="px-2 sm:px-4 pb-2 sm:pb-4">
          <div className="relative">
            ...
            />
            <div className="absolute left-2 sm:left-3 top-2.5 text-neutral-400">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className={`${activeId ? 'hidden lg:flex' : 'flex'} w-full lg:w-80 border-r border-neutral-700 bg-neutral-800 flex-col h-screen overflow-hidden`}>
        ...
        <div className={`${activeId ? 'flex' : 'hidden lg:flex'} flex-1 flex-col h-screen overflow-hidden`}>
          
          {/* Back button for mobile */}
          {activeId && (
            <div className="lg:hidden border-b border-neutral-700 bg-neutral-800 p-2">
              <button
                onClick={() => setActiveId(null)}
                className="flex items-center gap-2 text-sm text-neutral-300 hover:text-accent-cream transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
