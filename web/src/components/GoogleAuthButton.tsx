...
export default function GoogleAuthButton({ 
  ...
  if (mode === 'signout') {
    return (
      <button
        onClick={() => signOut()}
        className={`w-full px-4 py-3 bg-neutral-700 border border-neutral-600 rounded-lg text-white hover:bg-neutral-600 transition-colors duration-200 flex items-center justify-center ${className}`}
      >
