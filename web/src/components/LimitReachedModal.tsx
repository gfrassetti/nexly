        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-accent-cream mb-2">¡Límite Alcanzado!</h3>
              <p className="text-neutral-300 text-sm">
                Has usado tu cuota de <strong className="text-orange-400">{currentUsage} / {monthlyLimit} Conversaciones Iniciadas</strong> de este mes.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <Button
                ...
                disabled={buyLoading}
              >
                {buyLoading ? 'Procesando...' : 'Comprar 500 Conversaciones Adicionales ($30 USD)'}
              </Button>
              {planType !== 'Business' && (
                <Button
