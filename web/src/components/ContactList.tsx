              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <div 
                      ...
                      style={{ display: contact.avatar || contact.profilePicture ? 'none' : 'flex' }}
                    >
                ...
                <div className="flex justify-between items-center mt-4 pt-3 border-t border-neutral-700 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      // TODO: Abrir chat con este contacto
                    }}
                  ...
                  <button
                    ...
                    className="text-red-400 hover:text-red-300 disabled:text-neutral-600 disabled:cursor-not-allowed px-3 py-1.5 rounded-lg text-sm transition-colors flex items-center gap-2"
                  >
